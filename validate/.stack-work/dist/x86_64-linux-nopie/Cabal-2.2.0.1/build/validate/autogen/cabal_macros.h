...
/* package validate-0.1.0.0 */
#ifndef VERSION_validate
#define VERSION_validate "0.1.0.0"
#endif /* VERSION_validate */
#ifndef MIN_VERSION_validate
#define MIN_VERSION_validate(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_validate */
...
#define CURRENT_COMPONENT_ID "validate-0.1.0.0-ArHuimF3hz31MAO2EU6HQx-validate"
